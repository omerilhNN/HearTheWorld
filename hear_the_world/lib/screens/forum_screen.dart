...
class _ForumScreenState extends State<ForumScreen>
  ...
  void initState() {
    ...
    _memoriesSubscription = _forumService.memoriesStream.listen((
      updatedMemories,
    ) {
      setState(() {
          ...
          (context) => AlertDialog(
            ...
            content: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    _isTurkish ? 'Anahtar kelime girin' : 'Enter keywords',
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  AccessibilityService().speak(
                    _isTurkish ? 'Arama iptal edildi' : 'Search canceled',
                  );
                },
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            context.go('/home');
            AccessibilityService().speak(
              _isTurkish ? 'Ana ekrana dön' : 'Back to home screen',
            );
          },
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      // Add image indicator if memory has an image
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  // Compact play/stop button that matches screenshot
                                  TextButton.icon(
