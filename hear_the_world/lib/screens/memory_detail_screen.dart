...
class _MemoryDetailScreenState extends State<MemoryDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_memory?.title ?? (_isTurkish ? 'Anı Detayı' : 'Memory Detail')),
        leading: IconButton(
          icon: const Icon(Icons.arrow_back),
          onPressed: () {
            AccessibilityService().speak(_isTurkish ? 'Forum ekranına dön' : 'Back to forum');
            context.go('/forum');
          },
                  ...
                  child: Column(
                    ...
                    children: [
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _isTurkish ? 'Sesli Anlatım' : 'Audio Narration',
                                    ...
                                    if (_memory!.durationSeconds != null)
                                      Text(
                                        _isTurkish ? 'Süre: ${_memory!.formattedDuration}' : 'Duration: ${_memory!.formattedDuration}',
                                        style: TextStyle(
                                          color: AppTheme.textSecondary,
                                          fontSize: 14,
                                        ),
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            _isTurkish ? 'Yorumlar (${_memory!.comments.length})' : 'Comments (${_memory!.comments.length})',
                      ...
                      if (_memory!.comments.isEmpty)
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Semantics(
                              label: 'Comment by ${comment.authorName}: ${comment.content}',
                              child: Padding(
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: _isTurkish ? 'Yorumunuzu yazın...' : 'Write your comment...',
